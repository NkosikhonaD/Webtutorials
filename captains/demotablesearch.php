...
if(isset($_POST['search']))// my submit button is called search ..
{
...
$myResults = mysqli_query($db,$query_student_nom) or die(mysqli_error($db));
?>
<!DOCTYPE html>
<html>
   <head>
  ...
  <body>
    ...
    <section id="newsletter">
      <div class="container">
        ...
        <form method = "post" action = "demotablesearch.php">
          <input type="text" name="SearchField" value="search" placeholder="Student Number">
          <button type="submit" name="search" class="button_1">Search</button>
        </form>
      </div>
    </section>
